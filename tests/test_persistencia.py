...
def test_load_data_arquivo_inexistente(tmp_path):
    """
    Testa se load_data retorna um dicionário vazio para um arquivo que não existe.
    """
...
def test_save_e_load_data(tmp_path):
    """
    Testa se save_data escreve os dados corretamente e load_data os lê de volta.
    """
...
def test_get_next_id():
    """
    Testa a lógica de geração do próximo ID.
    """
...
def test_salvar_novo_usuario_chama_funcoes_corretas(mock_save, mock_load):
    """
    Testa se salvar_novo_usuario chama load_data e save_data corretamente.
    """
